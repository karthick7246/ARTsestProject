...
public class SsdSample : MonoBehaviour
{
    ...
    //
   // public GameObject FrameContain;

    //
    [SerializeField]
    private Text framePrefab = null;
    public Text TestConsole;
    ...
    private void Start()
    {
       ...
       // Transform parent = FrameContain.transform;
